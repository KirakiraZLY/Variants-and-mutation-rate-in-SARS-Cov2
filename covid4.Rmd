...
test.stat1 <- mean(covid_specific$count_N[covid_specific$pangolin_lineage == "XBB"]) -
    mean(covid_specific$count_N[covid_specific$pangolin_lineage == "BQ.1.1"])
test.stat1


covid_specific <- covid_specific[covid_specific$pangolin_lineage == c("XBB","BQ.1.1"),]
# covid_specific$VarShort[covid_specific$`Patient age` > 40] = "VOC Delta GK 2"
...
plot(density(Boot.test.stat1),
     xlab = expression(bar(Yc) - bar(Ym)),
     main = "mean t-test on Count_N of XBB & BQ.1.1")
```
